...
`` git clone  https://github.com/Alsaahir/sorting_algorithms.git ``

Create your main file with specifc Requirement 
...
## Author
* Jacob Mwale [Alsaahir](https://github.com/Alsaahir)
